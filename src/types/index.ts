...
export interface ServerToClientEvents {
  ...
  // Ride Events
  ride_request: (data: Ride & { estimated_arrival: string; driver_distance: string; target_driver_id?: string; is_fallback_broadcast?: boolean; is_retry?: boolean; retry_attempt?: number }) => void;
  ...
  // Keep-alive Events
  server_ping: (data: { timestamp: string }) => void;
}
...
export interface ClientToServerEvents {
  ...
  driver_ping: (data: { driver_id?: string }, ack?: (response: { status: string; timestamp?: string; driver_status?: any; message?: string; needs_reconnect?: boolean; recovery_performed?: boolean }) => void) => void;
